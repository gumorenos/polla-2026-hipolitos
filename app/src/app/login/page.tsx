...
import { determineLoginRedirect } from '../../lib/auth-redirect';
      ...
      <div className="w-full max-w-sm card-base p-6 border-border-active relative z-10 bg-bg-tertiary/90 backdrop-blur-md">
        <Suspense fallback={
          <div className="flex flex-col items-center justify-center py-8">
            <div className="w-8 h-8 border-2 border-gold-400/20 border-t-gold-400 rounded-full animate-spin"></div>
            <p className="mt-4 text-xs font-mono text-gold-400 uppercase tracking-widest animate-pulse">Cargando...</p>
          </div>
        }>
          <LoginFormInner />
        </Suspense>
